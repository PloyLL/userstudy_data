function getFileName(i, j, data_id) {
    return `./DreamFusion_files/content/rotate_light/${data_id}/res_${('00' + i).slice(-2)}_${('00' + j).slice(-2)}.png`;
}
...
$(document).ready(function() {
    ...
    for (let k = 0; k < folder.length; k++){
        ...
        $(`.rot_img${k+1}`).attr("src", `./DreamFusion_files/content/rotate_light/${folder[k]}/res_00_00.png`);
